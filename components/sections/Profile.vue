<template lang="pug">
section(data-scroll-section id="profile" data-scroll-id="profile")
  .container
    .row.no-gutters.justify-content-center.align-items-center(
      ...
      h2(data-scroll class="animate__animated fade_in") {{$t('profile.title')}}
      p(data-scroll class="animate__animated fade_in") {{$t('profile.description')}}
